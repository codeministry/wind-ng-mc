...
class admin_regions {
	...
	function table_regions() {
		...
		$table_regions->db_data(
			'regions.id, regions.name, regions.ip_start, regions.ip_end, regions.dns_suffix, regions.info, regions.image, regions.min_lat, regions.min_long, regions.max_lat, regions.max_long',
			'regions',
			"",
			"",
			"ip_start ASC");
