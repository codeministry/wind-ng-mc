...
$lang = array(
	...
	'db' => array(
		...
		'nodes__freeifs' => 'Ελεύθερα Interfaces',
		'nodes__url' => '<acronym title="Πληκτρολογήστε το URL της σελίδας που θέλετε να εμφανίζεται στο http://όνομαΤουΚόμβουΣας.wna.gr">Ιστοσελίδα κόμβου</acronym> (Δώστε το πλήρες URL <br>που θέλετε να εμφανίζεται όταν κάποιος επισκέπτεται <br>το subdomain http://<ονομακόμβου>.wna.gr) ',
	...
	'email' => array(
		'user_activation' => array(
			...
			'body' => "WiND.WNA.gr - Wireless Networks Association\nWiND - Wireless Nodes Database\n------------------------------------------\nΕνεργοποίηση λογαριασμού ##username##\n\nΠατήστε εδώ: ##act_link##\n\n-- \nWireless Networks Association\n17ο χμ Θεσσαλονίκης - Περαίας,\nστροφή Ν. Ρυσίου (Drive Park), Thessaloniki,\nMacedonia, Greece. Τ.Θ. 473 Νέο Ρύσιο,\n\nΤηλ./FAX: +302312205626 "
		),

		'user_restore' => array(
			'subject' => "WiND.WNA.gr:Ανάκτηση κωδικού: ##username##",
			'body' => "WiND.WNA.gr - Wireless Networks Association\nWNA.gr - Wireless Networks Association\nWiND - Wireless Nodes Database\n------------------------------------------\n\nΑνάκτηση κωδικού για το λογαριασμό ##username##\n\nΠατήστε εδώ: ##act_link##\n\n-- \nWireless Networks Association\n17ο χμ Θεσσαλονίκης - Περαίας,\nστροφή Ν. Ρυσίου (Drive Park), Thessaloniki,\nMacedonia, Greece. Τ.Θ. 473 Νέο Ρύσιο,\n\nΤηλ./FAX: +302312205626 "
		),
		...
		'range' => array(
			...
			'active' => array(
				...
				'body' => "WiND.WNA.gr - Wireless Networks Association\nWiND - Wireless Nodes Database\n------------------------------------------\n\nIP C-Class: ##range##\nΚόμβος: ##node_name## (###node_id##)\n\nΤο παραπάνω IP C-Class ενεργοποιήθηκε.\n\nΕκ μέρους της ομάδας WiND Hostmaster,\n##hostmaster_surname## ##hostmaster_name## (##hostmaster_username##)\n\n Υπενθυμίζεται ότι το όνομακόμβου.wna.gr αποτελεί ενεργό URL που ορίζεται μέσα από το WiND. \n Επιπλέον σε κάθε διασύνδεσή σας μπορείτε να δηλώσετε την IP του Interface από την μεριά σας έτσι ώστε να δημιουργηθεί αυτόματα το κατάλληλο Reverse DNS record με βάση την πανελλαδική διευθυσιοδότηση και τα επιθέματα DNS (http://www.wna.gr/wiki/addressing). \n Για περισσότερες πληροφορίες ανατρέξτε στο Wiki του WNA ή ρωτήστε στο φόρουμ. \n\n-- \nWireless Networks Association\n17ο χμ Θεσσαλονίκης - Περαίας,\nστροφή Ν. Ρυσίου (Drive Park), Thessaloniki,\nMacedonia, Greece. Τ.Θ. 473 Νέο Ρύσιο,\n\nΤηλ./FAX: +302312205626 "
			),
			'rejected' => array(
			...
			'invalid' => array(
				...
				'body' => "WNA.gr - Wireless Networks Association\nWiND - Wireless Nodes Database\n------------------------------------------\n\nIP C-Class: ##range##\nΚόμβος: ##node_name## (###node_id##)\n\nΤο παραπάνω IP C-Class ακυρώθηκε.\n\nΕκ μέρους της ομάδας WiND Hostmaster,\n##hostmaster_surname## ##hostmaster_name## (##hostmaster_username##)\n\n-- \nWireless Networks Association\n17ο χμ Θεσσαλονίκης - Περαίας,\nστροφή Ν. Ρυσίου (Drive Park), Thessaloniki,\nMacedonia, Greece. Τ.Θ. 473 Νέο Ρύσιο,\n\nΤηλ./FAX: +302312205626 "
			)
		),
