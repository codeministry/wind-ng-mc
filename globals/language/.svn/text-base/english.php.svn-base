...
$lang = array(
	...
	'hpl' => "<Hidden> (please login)",
	'adpl' => "Access Denied, please login",
	...
	'db' => array(
		...
		'nodes__info' => 'Info',
		'nodes__url' => '<acronym title="The web page that nodename.wna.gr delegates">Node web site</acronym>',
		'nodes__name_ns' => 'Nameserver prefix',

    	'nodes__internetaccess' => 'Internet Access',
		'nodes__internetprovider'=>'Internet Provider',
		'nodes__community_id' => "Wireless community/team",
		'nodes__com_wind_id' => "Node id at local community <br>(if exists)",
