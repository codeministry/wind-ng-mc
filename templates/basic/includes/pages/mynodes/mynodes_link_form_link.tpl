...
<table class="table-form" id="{$extra_data.FORM_NAME}_t">
		...
		<td class="table-form-field">
			3<select class="fld-form-input" name="{$data[3].fullField}">
		...
		<tr class="table-form-row2"><td class="table-form-title">{$lang.db[$data.4.fullField]}{if $data[4].Null != 'YES'}*{/if}:</td><td class="table-form-field">4<input class="fld-form-input" name="{$data[4].fullField}" type="text" value="{$data[4].value|escape}" /></td></tr>
		<tr class="table-form-row2"><td class="table-form-title">{$lang.db[$data.5.fullField]}{if $data[5].Null != 'YES'}*{/if}:</td><td class="table-form-field">5<input class="fld-form-input" name="{$data[5].fullField}" type="text" value="{$data[5].value|escape}" /></td></tr>
		<tr class="table-form-row2"><td class="table-form-title">{$lang.db[$data.10.fullField]}{if $data[10].Null != 'YES'}*{/if}:</td><td class="table-form-field">10<input class="fld-form-input" name="{$data[10].fullField}" type="text" value="{$data[10].value|escape}" /></td></tr>

		<tr class="table-form-row1"><td class="table-form-title">{$lang.db[$data.6.fullField]}{if $data[6].Null != 'YES'}*{/if}:</td>
		<td class="table-form-field">
			6<select class="fld-form-input" name="{$data[6].fullField}">
		...
		<tr class="table-form-row2"><td class="table-form-title">{$lang.db[$data.7.fullField]}{if $data[7].Null != 'YES'}*{/if}:</td><td class="table-form-field">7<textarea class="fld-form-input" name="{$data[7].fullField}">{$data[7].value|escape}</textarea></td></tr>
		<tr class="table-form-row1"><td class="table-form-title">{$lang.db[$data.8.fullField]}{if $data[8].Null != 'YES'}*{/if}:</td><td class="table-form-field">8<textarea class="fld-form-input" name="{$data[8].fullField}">{$data[8].value|escape}</textarea></td></tr>

		<tr class="table-form-row1"><td class="table-form-title">{$lang.db[$data.9.fullField]}{if $data[9].Null != 'YES'}*{/if}:</td>
		<td class="table-form-field">
			9<select class="fld-form-input" name="{$data[9].fullField}">
