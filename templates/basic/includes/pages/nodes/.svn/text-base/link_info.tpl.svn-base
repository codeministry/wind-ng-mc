...
<tr>
	<td class="table-node-key2">{$lang.db.links__security}</td>
	<td class="{if $data[rowl].links__security == 'sec_active'}link-up{else}link-down{/if}">{assign var=t value="links__security-"|cat:$data[rowl].links__security}{$lang.db.$t}</td>
</tr>
<tr>
...
<tr>
	<td class="table-node-key2">{$lang.db.links__ip}</td>
	<td class="table-node-value2">{$data[rowl].links__ip|escape}</td>
</tr>
</table>
		</td>
