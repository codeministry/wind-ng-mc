...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-middle-left">
	<tr>
		...
		{else}
				...
				<tr bgcolor="#FFFFFF">
					<td class="table-small-menu-text"><a href="http://www.wna.gr/forum/member.php?action=register" class="menu-link">{$lang.register}</a></td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td class="table-small-menu-text"><a href="http://www.wna.gr/forum/member.php?action=lostpw" class="menu-link">{$lang.password_recover}</a></td>
				</tr>
	...
	<tr>
		<td class="search-menu">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-search-menu">
				<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/search_nodes.gif" width="16" height="16" alt="{$lang.all_nodes}" />&nbsp;<a href="{$link_allnodes}">{$lang.all_nodes}</a></td>
			  	</tr>
			  	{*<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/search_dns.gif" width="16" height="16" alt="{$lang.all_zones}" />&nbsp;<a href="{$link_alldnszones}">{$lang.all_zones}</a></td>
			  	</tr>*}
				<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/dns-small.png" width="16" height="16" alt="{$lang.communities}" />&nbsp;<a href="{$link_communities}">{$lang.communities}</a></td>
			  	</tr>
			  	<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/search_ip.gif" width="16" height="16" alt="{$lang.all_ranges}" />&nbsp;<a href="{$link_allranges}">{$lang.all_ranges}</a></td>
				</tr>
				<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/services.gif" width="16" height="16" alt="{$lang.all_services}" />&nbsp;<a href="{$link_allservices}">{$lang.all_services}</a></td>
		  		</tr>
			  	<tr>
    	...
    	<td class="search-menu">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-search-menu">
				<tr>
			  	...
			  	<tr>
					<td rowspan="6" class="quick-login-text"><img src="templates/basic/images/stats.png" width="48" height="48" alt="{$lang.statistics}" /></td>
					<td class="quick-login-text">{$stats_communities} <span style="color: black;">Wireless Communities</span>
<br>{$stats_nodes_active}/{$stats_nodes_total} <span style="color: black;">{$lang.active_nodes|lower}</span></td>
			  	...
			  	<tr>
					<td class="quick-login-text">{$stats_aps} <span style="color: black;">{$lang.aps|lower}</span>
					<br>{$stats_hotspots} <span style="color: black;">Hotspots</span></td>
			  	</tr>
   ...
   <tr>
		<td class="search-menu">
			...
			<td class="table-form-title"><img src="templates/basic/images/node-small.png" alt="{$lang.mynodes}" />&nbsp;<a href="{$mynodes[row].url_view}">{$home_node[row].name|escape} (#{$home_node[row].id})</a>&nbsp;
					<br />
					<span style="font-weight:bold; font-size: 7px; color: orange;">|<a href="{$mynodes[row].url}">{$lang.edit_node}
					<img src="templates/basic/images/submit1.png" alt="{$lang.node}" /></a>|</span>	
			...
			{/if}
					<td class="table-form-title"><img src="templates/basic/images/node-small.png" alt="{$lang.mynodes}" />&nbsp;<a href="{$mynodes[row].url_view}">{$mynodes[row].name|escape} (#{$mynodes[row].id})</a>&nbsp;
					<br />
					<span style="font-weight:bold; font-size: 7px; color: orange;">|<a href="{$mynodes[row].url}">{$lang.edit_node}
					<img src="templates/basic/images/submit1.png" alt="{$lang.node}" /></a>|</span>
	...
	<tr>
		<td class="search-menu">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-mynodes">
				...
				{/if}
				{if $link_admin_communities != ''}
				<tr class="table-form-row1">
					<td colspan="2" class="table-form-title"><img src="templates/basic/images/areas-small.png" alt="{$lang.areas}" />&nbsp;<a href="{$link_admin_communities}">wireless communities</a></td>
				</tr>
				{/if}
